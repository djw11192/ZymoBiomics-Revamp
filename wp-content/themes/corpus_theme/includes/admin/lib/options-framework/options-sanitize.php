...
function mudthemes_of_sanitize_text($input) {
	$output = wp_check_invalid_utf8($input);	
	return $output;
}

add_filter( 'mudthemes_of_sanitize_text', 'mudthemes_of_sanitize_text' );
add_filter( 'mudthemes_of_sanitize_sortable', 'mudthemes_of_sanitize_text' );
...
function mudthemes_of_recognized_background_repeat() {
	$default = array(
                'repeat-mud' => __('repeat', 'corpus'),
		'no-repeat' => __('No Repeat', 'corpus'),
		'repeat-x'  => __('Repeat Horizontally', 'corpus'),
		'repeat-y'  => __('Repeat Vertically', 'corpus'),
		'repeat'    => __('Repeat All', 'corpus'),
		);
...
function mudthemes_of_recognized_background_position() {
	$default = array(
                'top-left-mud' => __('top left', 'corpus'),
		'top left'      => __('Top Left', 'corpus'),
		'top center'    => __('Top Center', 'corpus'),
		'top right'     => __('Top Right', 'corpus'),
		'center left'   => __('Middle Left', 'corpus'),
		'center center' => __('Middle Center', 'corpus'),
		'center right'  => __('Middle Right', 'corpus'),
		'bottom left'   => __('Bottom Left', 'corpus'),
		'bottom center' => __('Bottom Center', 'corpus'),
		'bottom right'  => __('Bottom Right', 'corpus')
		);
...
function mudthemes_of_recognized_background_attachment() {
	$default = array(
                'scroll-mud' => __('fixed', 'corpus'),
		'scroll' => __('Scroll Normally', 'corpus'),
		'fixed'  => __('Fixed in Place', 'corpus')
		);
	return apply_filters( 'mudthemes_of_recorpusd_background_attachment', $default );
}
...
function mudthemes_of_recognized_font_styles() {
	$default = array(
		'normal'      => __('Normal', 'corpus'),
		'italic'      => __('Italic', 'corpus'),
		'bold'        => __('Bold', 'corpus'),
		'bold italic' => __('Bold Italic', 'corpus')
		);
...
function mudthemes_on_skin_change($input) {
    switch($input['skin']):

        case 'white':
            $input['color_site_title'] = "#555555";
            $input['color_site_desc'] = "#555555";
            $input['color_blog_p_title'] = "#444444";
            $input['color_blog_p_meta'] = "#000000";
            $input['color_blog_p_content'] = "#000000";
            $input['color_readmore'] = "#FFFFFF";
            $input['color_p_title'] = "#000000";
            $input['color_p_meta'] = "#000000";
            $input['color_p_content'] = "#000000";
            $input['color_p_link'] = "#0000FF";
            $input['color_p_link_v'] = "#5757FF";
            $input['color_p_link_h'] = "#0000A8";
            $input['color_bg_blog_style_date'] = "#EC6A00";
            $input['color_bg_readmore'] = "#EC6A00";
        ...
        case 'orange':
            ...
            $input['color_p_meta'] = "#000000";
            $input['color_p_content'] = "#000000";
            $input['color_p_link'] = "#D75600";
            $input['color_p_link_v'] = "#FF822F";
            $input['color_p_link_h'] = "#803300";
            $input['color_bg_blog_style_date'] = "#D75600";
            $input['color_bg_readmore'] = "#D75600";
            break;
        ...
        case 'olive':
            ...
            $input['color_p_meta'] = "#000000";
            $input['color_p_content'] = "#000000";
            $input['color_p_link'] = "#788F0A";
            $input['color_p_link_v'] = "#BCE010";
            $input['color_p_link_h'] = "#343e04";
            $input['color_bg_blog_style_date'] = "#788F0A";
            $input['color_bg_readmore'] = "#788F0A";
            break;
        ...
        case 'navy':
            ...
            $input['color_p_meta'] = "#000000";
            $input['color_p_content'] = "#000000";
            $input['color_p_link'] = "#09779B";
            $input['color_p_link_v'] = "#0EB6ED";
            $input['color_p_link_h'] = "#043849";
            $input['color_bg_blog_style_date'] = "#09779B";
            $input['color_bg_readmore'] = "#09779B";
            break;
