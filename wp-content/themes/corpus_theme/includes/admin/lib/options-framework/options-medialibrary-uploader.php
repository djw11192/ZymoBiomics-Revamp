	...
	function optionsframework_media_scripts( $hook ) {
		...
		if ( function_exists( 'wp_enqueue_media' ) )
			wp_enqueue_media();
                ...
                //wp_register_script( 'of-medialibrary-uploader', CORPUS_ASSETS .'admin/js/of-medialibrary-uploader.js', array( 'jquery', 'thickbox' ) );
		wp_register_script( 'of-media-uploader', CORPUS_ASSETS_URL .'admin/js/of-medialibrary-uploader.js', array( 'jquery' ), corpus_get_scripts_info('mudpanel', 'version') );
